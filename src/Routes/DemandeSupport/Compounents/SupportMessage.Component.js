...
export default function RecipeReviewCard(props) {
    ...
    return (
        <Card sx={{boxShadow:2 , margin: "25px" }}>
            <CardHeader
                ...
                <Box sx={{
                    ...
                    <IconButton onClick={()=> window.location.href='http://localhost:5000/DemandeSupport'} sx={{ margin : '0px 20px 0px 0px'}}  aria-label="settings">
                        <img  src={backIcon} />
                    </IconButton>
