...
export default function AgentProfileView(props) {
  ...
  return (
      <Card variant="outlined" className="noir" sx={{ width: 'fit-content',maxWidth:"45%"}}>
          <CardContent>
            ...
            <ListItemText
              ...
              secondary={ [<span className="lora-400">{props.respo?.family_name} {props.respo?.name}</span>]}
            />
          </ListItem>
              </div>
              <ListItem key="email" >
          ...
          <ListItemText
              ...
              secondary={ [<span className="lora-400">{props.respo?.email}</span>]}
          />
        </ListItem>
          ...
          <ListItemText
              ...
              secondary={ [<span className="lora-400">{props.respo?.phone_number}</span>]}
          />
        </ListItem>
            </List>
          </CardContent>
