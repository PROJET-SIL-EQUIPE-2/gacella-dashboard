...
import VehiculeNonDispoDetails from "./Compounents/VehiculeNonDispoDetails.Compounent";
...
const SuiviVehiculesRoute = () => {
  ...
  const [
    isAjouterVehiculeDialogOpen,
    setAjouterVehiculeDialogOpen,
  ...
  return vehicules.loading || vehicules.error ? (
    <div style={{ width: "100%" }}>
      <Grid
        container
        spacing={1}
    ...
    <div style={{ width: "100%" }}>
        ...
        <Grid item xs={12}>
          ...
          >
            <div className="d-flex justify-content-around align-items-center">
              ...
              <IconButton
                size="large"
                aria-label="Ajouter un vehicule"
                color="primary"
                onClick={(event) => {
                  setAjouterVehiculeDialogOpen(true);
                }}
              >
          ...
          >
            ...
            >
              {vehicules?.data
                ?.filter(
                  (vehicule) =>
                    vehicule.disponible === (toggle === "disponible")
                )
                .map((vehicule, index) => {
                  return (
                    <Grid
                    ...
                    >
                      <CarteVehicule
                        onCardClick={() =>
                          setVehiculeDetailsData(true, vehicule)
                        }
      ...
      {VehiculeDetails.vehicule?.disponible ? (
